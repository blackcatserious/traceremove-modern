...
function drawBarChart(
  ...
  data.forEach((item, index) => {
    ...
    if (!Number.isFinite(x) || !Number.isFinite(y) || !Number.isFinite(barWidth) || !Number.isFinite(barHeight)) return;
