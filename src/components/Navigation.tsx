...
const MegaMenuPanel = lazy(() => import('./navigation/MegaMenuPanel'));

function MegaMenuLoadingFallback({
  dropdownMetrics,
  label,
  onEnter,
  onLeave,
