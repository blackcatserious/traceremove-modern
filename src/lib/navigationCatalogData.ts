...
export const navigationCatalog: NavigationCatalog = {
  ...
  research: {
    ...
    dropdown: [
      ...
      },
      {
        ...
        label: 'Big Data Interpretability',
      ...
      },
      {
        ...
        label: 'Language & Code Interoperability',
  ...
  tools: {
    ...
    dropdown: [
      ...
      },
      {
        ...
        label: 'Language Model Comparison',
  ...
  atlas: {
    ...
    dropdown: [
      {
        href: '/atlas',
        label: 'Experience Atlas Overview',
      ...
      },
      {
        ...
        label: 'Transparent Governance · Global',
      ...
      },
      {
        ...
        label: 'Civic Participation · Consortium',
  ...
  articles: {
    ...
    dropdown: [
      ...
      },
      {
        ...
        label: 'Case Study: AI in Social Systems',
