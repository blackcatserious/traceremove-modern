...
export const metadata: Metadata = {
  title: "Artur Ziganshin — AI Philosophy Research | Traceremove",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Traceremove — AI Philosophy Research",
      },
    ],
  },
  twitter: {
    ...
    <html lang="en" suppressHydrationWarning>
      <body className={`${instrumentSerif.variable} ${sourceSans.variable} ${jetbrainsMono.variable} antialiased`}>
        <ThemeProvider attribute="class" defaultTheme="system" enableSystem disableTransitionOnChange>
          <a
            href="#main-content"
            className="sr-only z-[100] rounded-md bg-accent-500 px-4 py-2 text-white focus:not-sr-only focus:fixed focus:left-4 focus:top-4"
          >
            Skip to content
          </a>
          <div className="grain-overlay relative min-h-screen bg-paper-white text-ink-900 dark:bg-paper-darker dark:text-ink-100">
            <Header />
