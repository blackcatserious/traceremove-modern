...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${b}/concepts`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    { url: `${b}/chat`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
    ...articles.map((a: any) => ({
      url: `${b}/articles/${a.slug}`,
