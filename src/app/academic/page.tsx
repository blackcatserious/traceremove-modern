...
const academicThemes = [
  {
    ...
    description: 'Documenting participatory research across civic tech, climate resilience, and digital rights movements.',
    icon: Users
  },
  {
    title: 'Philosophical rigour',
    description: 'Integrating ethics, phenomenology, and socio-technical critique with systems engineering.',
    icon: BookOpen
  },
  {
    title: 'Motion storytelling',
    description: 'Cinematic teaching aids and visual archives translate complex findings into accessible narratives.',
    icon: Bookmark
  }
];
        ...
        <section className="grid gap-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-10">
            ...
            >
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.35em] text-white/70">Academic portfolio</span>
