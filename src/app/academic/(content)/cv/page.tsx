...
import { ArrowLeft, Clock, Tag, BookOpen, TrendingUp, Download, User, GraduationCap, Award } from 'lucide-react';
  ...
  return (
    ...
    <>
      ...
      <section className="relative decorative-blobs overflow-hidden py-12 sm:py-16">
        ...
        <div className="relative decorative-content max-w-4xl mx-auto">
          <motion.div
