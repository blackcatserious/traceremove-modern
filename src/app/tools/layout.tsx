...
export default function ToolsLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(14,165,233,0.18),transparent_58%),radial-gradient(circle_at_82%_16%,rgba(99,102,241,0.22),transparent_60%),linear-gradient(180deg,rgba(2,6,23,0.97)_0%,rgba(8,47,73,0.94)_50%,rgba(8,47,73,0.9)_100%)]"
      />
